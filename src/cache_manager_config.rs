...
pub struct CacheManagerConfig {
    ...
    max_pending_bulk_ms_await: Duration,
...
impl CacheManagerConfig {
    pub fn new(max_pending_ms_await: u64, max_pending_bulk_ms_await: u64, max_task_drain_size: u64) -> Self {
        Self {
            ...
            max_pending_bulk_ms_await: Duration::from_millis(max_pending_bulk_ms_await),
            max_task_drain_size,
        }
    }
    ...
    pub fn max_pending_bulk_ms_await(&self) -> Duration {
